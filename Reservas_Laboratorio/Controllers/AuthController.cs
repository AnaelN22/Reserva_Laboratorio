...
namespace Reservas_Laboratorio.Controllers
{
    public class AuthController(IAuthService authService) : Controller
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterRequestDto dto)
        {
            ...
            if (!success)
            {
                //ModeState.AddModelError("", error ?? "Error al registrar.");
                return Conflict(new
                {
                    Message = error
                });
        ...
        public async Task<IActionResult> ConfirmEmail(string email, string token)
        {
            ...
            if (confirmado)
            {
                TempData["Success"] = "¡Correo confirmado con exito! Ahora puedes iniciar sesión.";
        ...
        // Primer paso para hacer la recuperación por olvidar password
        [HttpPost]
        ...
        public async Task<IActionResult> ChangePassword(ChangePasswordDto dto)
        {
            ...
            ModelState.AddModelError("", "Contraseña actual incorreta.");
            return View(dto);
        }
